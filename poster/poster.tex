...
%
\begin{equation*}
  \boxed{\;\operatorname{EIG}_\varepsilon(S;\, x) = H_b\!\big(\varepsilon + (1 - 2\varepsilon)\,p\big) - H_b(\varepsilon)\;}
\end{equation*}

where $p := P(y\!=\!1) = \mathbb{E}_{s \sim p(S)}\!\big[p(y \mid x,\, s)\big]$.
...
%
\begin{equation*}
  x_t^{\star} \in \arg\max_{x \in \mathcal{X}}\; \operatorname{EIG}_\varepsilon(x \mid p_t(S))
\end{equation*}
...
%
\begin{equation*}
  u_t^{\star} \in \arg\max_{u}\; p_{\mathrm{hit}}(u), \;\; p_{\mathrm{hit}}(u) \coloneqq \!\!\sum_{s} p_t(s)\, \mathbb{1}[u \text{ is ship in } s]
\end{equation*}
...
%
\begin{equation*}
  \text{Ask } x_t^{\star} \;\text{if}\; \gamma\,\widehat{p}_{\mathrm{hit}}^{\,t+1}(x_t^{\star}) \;>\; p_{\mathrm{hit}}(u_t^{\star})
\end{equation*}
